    ...
    <div class="layout-wrapper">
        ...
        <div class="layout-sidebar">
            ...
            <ul class="layout-menu">
                ...
                <li>
                    <a href="{{ route('academic-results') }}" class="{{ request()->routeIs('academic-results') ? 'active' : '' }}">
                        <i class="fas fa-chart-bar layout-menuitem-icon"></i>
                        <span>نتائج الطالب النهائية</span>
                    </a>
                </li>
                <li>
