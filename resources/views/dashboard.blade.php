                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="academic-stats">
                            ...
                            <div class="stat-card">
                                <div class="stat-value">{{ $graduationProgress['completed_hours'] }}</div>
                                <div class="stat-label">الساعات المنجزة</div>
                            </div>
                            <div class="stat-card">
                                <div class="stat-value">{{ $graduationProgress['remaining_hours'] }}</div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted small">عرض ال��واد المطلوبة للتخرج</p>
                            </div>
                        </div>
                    </div>
                </div>
